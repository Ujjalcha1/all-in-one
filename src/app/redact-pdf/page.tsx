      ...
      {!file ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8">
          <div className="bg-white dark:bg-zinc-950 rounded-3xl border border-zinc-200/80 dark:border-zinc-800 shadow-2xl p-10 text-center space-y-6 max-w-xl w-full">
            ...
            <h3 className="font-extrabold text-2xl text-zinc-900 dark:text-white">Redact PDF Document</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Permanently mask and black-out confidential text and graphics from your PDF pages.
            </p>
